...
if __name__ == '__main__':
    ...
    if args.language == 'en':
        ...
        from nemo_text_processing.inverse_text_normalization.fa.taggers.tokenize_and_classify import (
            ClassifyFst as ITNClassifyFst,
        )
        from nemo_text_processing.inverse_text_normalization.fa.verbalizers.verbalize import (
            VerbalizeFst as ITNVerbalizeFst,
        )
        from nemo_text_processing.text_normalization.fa.taggers.tokenize_and_classify import (
            ClassifyFst as TNClassifyFst,
        )
        from nemo_text_processing.text_normalization.fa.verbalizers.verbalize import VerbalizeFst as TNVerbalizeFst
    else:
